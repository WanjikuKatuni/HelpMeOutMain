    ...
    <main className="relative top-10 w-full flex items-center justify-center pt-10">
      <section className="grid grid-cols-1 place-items-center gap-2 w-[30%]">
        ...
        <form action="" className="w-full grid grid-cols-1 gap-4">
          ...
          <button className="p-2.5 mt-2 bg-[#120B48] border border-[#120B48] rounded-md text-[18px] text-white text-center decoration-none cursor-pointer hover:bg-white hover:text-black transition-all">Sign Up</button>
        </form>
      </section>
    </main>
  );
